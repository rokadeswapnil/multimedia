...
const DetailsBanner = ({ video, crew }) => {
  ...
  const watchLaters = async () => {
    ...
    await setDoc(doc(db, "users", user?.uid, "watchlater", id), _doc).then(
      () => {
    ...
    // await setDoc(doc(db,"watchlater",user.uid),_doc).then(()=>{
    //     watchLaterrefetch()
    //     toast.success("added to watch later")
  };
                    ...
                    <div className="row">
                      ...
                      {!watchLaterisLoading ? (
                        <>
                          ...
                          >
                            <lord-icon
                              src="https://cdn.lordicon.com/auzndftu.json"
                              trigger="hover"
